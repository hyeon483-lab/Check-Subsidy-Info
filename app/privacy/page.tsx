  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-10 text-gray-700">
      ...
      <div className="space-y-6 leading-relaxed">
        <section>
          <h2 className="mb-2 text-lg font-semibold text-gray-900">1. 수집하는 개인정보 항목</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-gray-900">2. 쿠키 및 광고</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-gray-900">3. 개인정보의 보유 및 이용 기간</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-lg font-semibold text-gray-900">4. 문의처</h2>
