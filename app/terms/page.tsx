...
export default function TermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6">
      <h1 className="mb-6 text-2xl font-bold tracking-tight text-slate-900 sm:text-3xl">이용약관</h1>
      <div className="space-y-6 rounded-2xl bg-white p-6 text-[15px] leading-relaxed text-slate-600 shadow-card ring-1 ring-slate-100 sm:p-8">
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">1. 서비스의 성격</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">2. 정보의 정확성</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">3. 외부 링크</h2>
          <p>
        ...
        <section>
          <h2 className="mb-2 text-base font-bold text-slate-900">4. 약관의 변경</h2>
